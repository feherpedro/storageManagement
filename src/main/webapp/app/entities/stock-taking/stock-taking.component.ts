...
currentAccount: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.stockTakingService.search({
                page: this.page - 1,
                query: this.currentSearch,
                size: this.itemsPerPage,
                sort: this.sort()}).subscribe(
                    (res: HttpResponse<StockTaking[]>) => this.onSuccess(res.body, res.headers),
    ...
    transition() {
        this.router.navigate(['/stock-taking'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: StockTaking) {
        return item.id;
    }
    registerChangeInStockTakings() {
        this.eventSubscriber = this.eventManager.subscribe('stockTakingListModification', (response) => this.loadAll());
    }
